...
Node<V>* Node<V>::clone(const Node<V>* n) {
	...
	switch (n->type) {
	case NODE4:
		return ArtNode4<V>::create(*static_cast<const ArtNode4<V>*>(n));
	case NODE16:
		return ArtNode16<V>::create(*static_cast<const ArtNode16<V>*>(n));
	case NODE48:
		return ArtNode48<V>::create(*static_cast<const ArtNode48<V>*>(n));
	case NODE256:
		return ArtNode256<V>::create(*static_cast<const ArtNode256<V>*>(n));
	case LEAF:
		return Leaf<V>::create(*static_cast<const Leaf<V>*>(n));
#ifdef USE_VARNODE
	case VARNODE: {
...
Node<V>* Node<V>::reorder_leaves(Node<V>* n) {
	...
	switch (n->type) {
	case NODE4:
		return static_cast<ArtNode4<V>*>(n)->reorder_leaves();
	case NODE16:
		return static_cast<ArtNode16<V>*>(n)->reorder_leaves();
	case NODE48:
		return static_cast<ArtNode48<V>*>(n)->reorder_leaves();
	case NODE256:
		return static_cast<ArtNode256<V>*>(n)->reorder_leaves();
	case LEAF:
		return static_cast<Leaf<V>*>(n)->reorder_leaves();
	}
...
void Node<V>::iter(Node<V>* n, std::function<void(const unsigned char*, uint32_t, V)> cb) {
	...
	switch (n->type) {
	case NODE4:
		return static_cast<ArtNode4<V>*>(n)->iter(cb);
	case NODE16:
		return static_cast<ArtNode16<V>*>(n)->iter(cb);
	case NODE48:
		return static_cast<ArtNode48<V>*>(n)->iter(cb);
	case NODE256:
		return static_cast<ArtNode256<V>*>(n)->iter(cb);
	case LEAF:
		return static_cast<Leaf<V>*>(n)->iter(cb);
#ifdef USE_VARNODE
	case VARNODE:
		return static_cast<ArtVarNode<V>*>(n)->iter(cb);
#endif
	}
...
void Node<V>::iter_nodes(Node<V>* n, std::function<bool(Node*, int)> cb, int depth) {
	...
	switch (n->type) {
	case NODE4:
		return static_cast<ArtNode4<V>*>(n)->iter_nodes(cb, depth);
	case NODE16:
		return static_cast<ArtNode16<V>*>(n)->iter_nodes(cb, depth);
	case NODE48:
		return static_cast<ArtNode48<V>*>(n)->iter_nodes(cb, depth);
	case NODE256:
		return static_cast<ArtNode256<V>*>(n)->iter_nodes(cb, depth);
	case LEAF:
		return static_cast<Leaf<V>*>(n)->iter_nodes(cb, depth);
	}
...
int Node<V>::node_size(Node<V>* n) {
	...
	switch (n->type) {
	case NODE4:
		return sizeof(ArtNode4<V>);
	case NODE16:
		return sizeof(ArtNode16<V>);
	case NODE48:
		return sizeof(ArtNode48<V>);
	case NODE256:
		return sizeof(ArtNode256<V>);
	case LEAF:
		return sizeof(Leaf<V>) + static_cast<Leaf<V>*>(n)->key_len + sizeof(V);
	}
...
int Node<V>::decrement_refcount(Node<V>* n) {
	...
	switch (n->type) {
	case NODE4:
		return static_cast<ArtNode4<V>*>(n)->decrement_refcount();
	case NODE16:
		return static_cast<ArtNode16<V>*>(n)->decrement_refcount();
	case NODE48:
		return static_cast<ArtNode48<V>*>(n)->decrement_refcount();
	case NODE256:
		return static_cast<ArtNode256<V>*>(n)->decrement_refcount();
	case LEAF:
		return static_cast<Leaf<V>*>(n)->decrement_refcount();
#ifdef USE_VARNODE
	case VARNODE:
		return static_cast<ArtVarNode<V>*>(n)->decrement_refcount();
#endif
	}
...
Node<V>** ArtNode<V>::find_child(ArtNode<V>* n, unsigned char c) {
	...
	switch (n->type) {
	case NODE4:
		return static_cast<ArtNode4<V>*>(n)->find_child(c);
	case NODE16:
		return static_cast<ArtNode16<V>*>(n)->find_child(c);
	case NODE48:
		return static_cast<ArtNode48<V>*>(n)->find_child(c);
	case NODE256:
		return static_cast<ArtNode256<V>*>(n)->find_child(c);
#ifdef USE_VARNODE
	case VARNODE:
		return static_cast<ArtVarNode<V>*>(n)->find_child(c);
#endif
	}
...
void ArtNode<V>::add_child(ArtNode<V>* n, Node<V>** ref, unsigned char c, Node<V>* child) {
	...
	switch (n->type) {
	case NODE4:
		return static_cast<ArtNode4<V>*>(n)->add_child(ref, c, child);
	case NODE16:
		return static_cast<ArtNode16<V>*>(n)->add_child(ref, c, child);
	case NODE48:
		return static_cast<ArtNode48<V>*>(n)->add_child(ref, c, child);
	case NODE256:
		return static_cast<ArtNode256<V>*>(n)->add_child(ref, c, child);
#ifdef USE_VARNODE
	case VARNODE:
		return static_cast<ArtVarNode<V>*>(n)->add_child(ref, c, child);
#endif
	}
...
void ArtNode4<V>::add_child(Node<V>** ref, unsigned char c, Node<V>* child) {
	if (this->num_children < 4) {
		...
		memmove(this->children + idx + 1, this->children + idx, (this->num_children - idx) * sizeof(Node<V>*));
